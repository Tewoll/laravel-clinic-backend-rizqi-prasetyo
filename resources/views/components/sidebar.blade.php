...
<div class="main-sidebar sidebar-style-2" style="overflow: auto visible; outline: none; touch-action: auto;"
    tabindex="1">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('home') }}">Rizqi Clinic</a>
        </div>
        ...
        <ul class="sidebar-menu">
            <li class='{{ Route::is('home') ? 'active' : '' }}'>
                <a class="nav-link" href="{{ route('home') }}"><i class="fas fa-home"></i> <span>General
                        Dashboard</span></a>
            </li>
            <li class="{{ Route::is('user.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('user.index') }}"><i class="fas fa-user">
                    </i> <span>User Management</span>
                </a>
            </li>
            <li class="{{ Route::is('doctor.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('doctor.index') }}"><i class="fas fa-user-ninja">
                    </i> <span>Doctor Management</span>
                </a>
            </li>
